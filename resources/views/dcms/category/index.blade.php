       ...
       <section class="panel">
          <div class="panel-body">
               ...
               <div class="alert alert-block alert-warning fade in">
                    <strong>Be Careful While Deleting Category!!</strong> It May bring Error on site.
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class=" form">
                              ...
                              dm_input('text','rows['.$loop->index.'][lang_name]', "Category Name (<strong>$lang->name</strong>)(<em style='color:red'>*</em>)", 'rows.'.$loop->index.'.lang_name');
                              ?>
                              @endforeach
                          </div>

...
<script>
       ...
       var updateOutput = function(e)
       {
           ...
           if (window.JSON) {
               ...
               console.log(dataString);
                  $.ajax({
                        type: "POST",
                        url: '/dashboard/other_menus/order',
                        data:  dataString,
   ...
   $(document).on("click",".del-button",function() {
           var x = confirm('Delete this Others Menu Office?');
           var id = $(this).attr('id');
         //   debugger;
           var url = "other_menus/"+id;
         //   alert(url);
        $object=$(this);
           if(x){
                $.ajax({
         ...
         $('#nestable-tag').on('click', function(e)
    {
        var target = $(e.target),
    ...
    $('#nestable-tag').on('reload', function(e){
      $('.dd').nestable('collapseAll');
    } );
   </script>
@endsection

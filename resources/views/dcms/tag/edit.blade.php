    ...
    <div class="col-lg-8 col-md-8 col-xs-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class=" form">
                    <?php
                    dm_hpostform(URL::route($_base_route . '.update', ['tag' => $data['tags']->id]), 'PUT');
                    dm_hidden('order', $data['tags']->order);
                    dm_custom_link_hinput_update('text', 'link', "Url", $data['tags']->url);
                    dm_menu_hinput_update('text', 'name', "Tag Name", $data['tags']->name); ?>
                    <?php
                    dm_hcheckbox('checkbox', 'status', 'Public', $data['tags']->status);

...
<section class="province-content mt-4 p-0 pb-5">
    <div class="container">
        <div class="province-header d-flex flex-column justify-content-center align-items-center mb-4">
            <h3 class="province-h1 mb-0 pb-0 position-relative">जल तथा मौसम</h3>
                    ...
                    <div class="card h-100 border-0 no-bg-card card-border-bottom">
                      ...
                      ?>
                        ...
                        <div class="card-body d-flex flex-column ps-0">
                            <h5 class="card-title ps-2">@if(isset($row->title)) {{ $row->title }}@endif</h5>
                ...
                {{-- <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="card h-100 border-0 no-bg-card card-border-bottom">
                        ...
                        <div class="card-body d-flex flex-column ps-0">
                            ...
                            <p class="card-text flex-grow-1 justify-text-istaniya-taha ps-2">नागरिक उड्ययन प्राधिकरणका अधिकारीलाई भेटेर यसको कारण बुझ्न घटनास्थल आइपुगेको छु | नागरिक उड्ययन प्राधिकरणका अधिकारीलाई भेटेर यसको कारण बुझ्न घटनास्थल आइपुगेको छु | नागरिक उड्ययन प्राधिकरणका अधिकारीलाई भेटेर यसको कारण बुझ्न घटनास्थल आइपुगेको छु | नागरिक उड्ययन प्राधिकरणका अधिकारीलाई भेटेर यसको कारण बुझ्न घटनास्थल आइपुगेको छु | नागरिक उड्ययन प्राधिकरणका अधिकारीलाई भेटेर यसको कारण बुझ्न घटनास्थल आइपुगेको छु</p>
                    </div></div>
                </div> --}}
            </div>  
            @endif
            ...
            <div class="col-12 card-border-bottom mb-3">
                <div class="card border-0">
                    <div class="row g-0">
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="baisakh-date mt-0">बैशाख १३, २०८१<span class=" ms-2">|<i
                                            class="ri-account-circle-fill fs-5 me-1 ms-2"></i>सम्पादक नेपाल</span>
                                </p>
                                <h4 class="card-title mt-4">गाउँपालिकाहरुले स्थानिय स्तरमा सेवा</h4>
                                <p class="card-text justify-text-istaniya-taha">गाउँपालिका नेपालमा ग्रामिण नगरपालिका
                                    अथवा स्थानिय प्रशासनिक इकाई हो। यो २०१५ को नेपालको संविधान अनुसार देशको संघीय
                                    पुनर्संरचनाको हिस्साको रूपमा स्थापित भएको हो। यसले सरकारको सेवा ग्रामिण

...
<div class="container-fluid mt-2">
    ...
    <div class="container p-0">
        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center mt-5"
            style="color:#1c1ca1;">
            <h2 class="fw-bold detail-heading2 m-0"> @if(isset($data['row']->name)) {{ $data['row']->name }} @endif</h2>
        </div>
    </div>
    <hr class="container">
    <div class="container">
        <div class="row g-4 ">
            {{-- single page design --}}
            <div class="col-lg-12">
                <img src="{{ asset('assets/frontend/images/18-confirmed.jpeg') }}" alt="img" style="width: 100%; height:100%; object-fit:cover;">
            </div>
            {{-- dobble page design --}}
            <div class="col-lg-6">
                <img src="{{ asset('assets/frontend/images/18-confirmed.jpeg') }}" alt="img" style="width: 100%; height:100%; object-fit:cover;">
    ...
    <div class="row mt-4">
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 d-flex justify-content-center">
            <img src="{{ ($data['row']->image) }}" class="detail-img1">
        </div>
    </div>
    <div class="container">
        <div class="row mt-4">
    ...
    @php
     $url = route('site.branch.post.show', ['id'=> $data['row']->staff_unique_id]);
    @endphp

...
class ProvincesController extends DM_BaseController
{
    protected $panel = 'Province';
    protected $base_route = 'dcms.province';
    protected $view_path = 'dcms.province';
    protected $model;
    protected $table;

    public function __construct(Province $model, Tracker $tracker, DM_Post $dm_post) {

...
class JournalCategoryController extends DM_BaseController
{
    protected $panel = 'Journal Category';
    protected $base_route = 'dcms.journal.category';
    protected $view_path = 'dcms.journal.category';
    protected $model;
    protected $table;

    public function __construct(JournalCategory $category, Tracker $tracker, DM_Post $dm_post) {
